...
export function ShareListForm({
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6">
      ...
      {/* Sharing options */}
      <div className="flex flex-col space-y-3 border-t pt-4 sm:space-y-4 sm:pt-6">
        ...
        <div className="flex gap-3 pb-2 sm:gap-6">
          {/* Instagram Button */}
          <button
            onClick={handleInstagramShare}
            className="flex flex-1 items-center justify-center rounded-lg bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 py-3 text-white transition-all hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 sm:py-4"
          >
          ...
          <button
            ...
            className="flex flex-1 items-center justify-center rounded-lg bg-blue-600 py-3 text-white transition-colors hover:bg-blue-700 sm:py-4"
          >
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
          ...
          <button
            ...
            className="flex flex-1 items-center justify-center rounded-lg bg-black py-3 text-white transition-colors hover:bg-gray-800 sm:py-4"
          >
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
