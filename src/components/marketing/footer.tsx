  ...
  return (
    ...
    >
      <div className="border-border-primary border-b">
        <div className="mb-12 grid grid-cols-1 gap-x-[8vw] gap-y-12 md:mb-18 md:gap-y-16 lg:grid-cols-[1fr_0.5fr] lg:gap-y-20">
      ...
      <div className="flex flex-col items-center justify-between pt-6 text-center text-sm md:flex-row md:items-center md:pt-8 md:pb-0">
